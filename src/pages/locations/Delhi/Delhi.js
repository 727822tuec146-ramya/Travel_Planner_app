    ...
    return(
      ...
      <div className="t-info">
          ...
          <div className="infobox module">
            <div className="box">
              <div className="title">
                ...
                <p>
                  Abu Delhi is open and ready to welcome you again to make new
          ...
          <div className="infobox module">
            <div className="box">
              <div className="title">
                ...
                <p>
                  The culture of Delhi, an emirate of the United Arab Emirates.
        ...
        <div className="more">
          ...
          <div className="cont">
            <p>
            Delhi, the capital city of India, is a vibrant melting pot of cultures, reflecting the rich history and diversity of the country. The city's culture is a blend of ancient traditions and modern influences, shaped by centuries of Mughal, British, and Indian rule.
            </p>
            <p>
            Delhi is home to people from various regions, speaking different languages and following distinct customs, which creates a unique cosmopolitan environment. The city's architecture showcases this diversity, with magnificent Mughal monuments like the Red Fort and Humayun's Tomb standing alongside colonial-era buildings and modern skyscrapers.
            </p>
            <p>
            The cultural fabric of Delhi is woven with festivals, art, music, and cuisine. Festivals like Diwali, Eid, Holi, and Christmas are celebrated with great enthusiasm, bringing together people from all walks of life. Delhi's food culture is equally diverse, offering a range of culinary delights from the spicy street food of Old Delhi to the sophisticated flavors of modern fusion restaurants.
            </p>
          </div>
        </div>
      </div>
